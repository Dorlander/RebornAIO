...
namespace Evade
{
    public static class SpellDatabase
    {
        ...
        static SpellDatabase()
        {
            ...
            Spells.RemoveAll(x => !LeagueSharp.Common.HeroManager.Enemies.Any(y => String.Equals(x.ChampionName, y.ChampionName, StringComparison.InvariantCultureIgnoreCase)));
        }
