...
namespace PRADA_Vayne.MyUtils
{
    ...
    public partial class EarlyList
    {
    ...
    public class EarlyEvade
    {
        ...
        public EarlyEvade()
        {
            ...
            MenuLocal.AddItem(new MenuItem("Enabled", "Enabled!").SetValue(new KeyBind("H".ToCharArray()[0], KeyBindType.Toggle))).SetFontStyle(FontStyle.Regular, Color.GreenYellow).Permashow(true, "PRADA - Early Evade Warning");
