...
namespace AutoJungle.Data
{
    ...
    /// </summary>
    public static class OrbwalkingForBots
    {
        /// <summary>
       ...
       /* private static void Obj_AI_Hero_OnPlayAnimation(Obj_AI_Base sender, GameObjectPlayAnimationEventArgs args)
        ...
        {
            if (Utils.GameTimeTickCount - LastAttackCommandT < 70 + Math.Min(60, Game.Ping) || target == null)
            {
                return;
            }
        ...
        public class Orbwalker
        {
            ...
            {
                get { return OrbwalkingMode.None; }
                set { _mode = value; }
            }
            ...
            public virtual AttackableUnit GetTarget()
            {
                     ...
                     mode == OrbwalkingMode.Freeze))
                {
                    ...
                    foreach (var minion in MinionList)
                    {
                        ...
                        if (minion.Team == GameObjectTeam.Neutral && minion.CharData.BaseSkinName == "gangplankbarrel" &&
                            minion.IsHPBarRendered)
                        {
                            if (minion.Health < 2)
                            {
                                return minion;
            ...
            private void GameOnOnGameUpdate(EventArgs args)
            {
                try
                {
                    ...
                    Orbwalk(target, Game.Ping * 2f, 100, false, true, true);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
