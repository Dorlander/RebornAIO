    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                _config.AddItem(
                    new MenuItem("OrbwalkToPassive", "Combo Orbwalk to Passive").SetShared().SetValue(new KeyBind('Z', KeyBindType.Press)));
            ...
            public OrbwalkingMode ActiveMode
            {
                get
                {
                    ...
                    if (_config.Item("OrbwalkToPassive").GetValue<KeyBind>().Active)
                    {
                        return OrbwalkingMode.OrbwalkPassive;
                    }
